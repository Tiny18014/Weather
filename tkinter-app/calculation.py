...
from sklearn.metrics import accuracy_score  # ✅ Import this
...
def process_inputs(inputs):
    ...
    # Convert "date" column to datetime format and then to timestamp
    ...
    y_pred = dec_df3.predict(x_test_df3)
    model_accuracy = accuracy_score(y_test_df3, y_pred)
    ...
    return result, model_accuracy  # ✅ Return both
